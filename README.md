...
- **Interactive MCQ Option Selection (v5.0.0)**: Select options during reviews (via click, touch, or keyboard digits `1-9`) to test your knowledge. Wrong selections highlight red and the true answer green on the back side. Integrates full selection persistence across repeat reviews.
