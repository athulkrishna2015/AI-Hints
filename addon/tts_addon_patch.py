...
# NOTE: BeautifulSoup is imported lazily inside setup_tts_addon_patch() so a
# missing bs4 install doesn't disable the whole patch module at import time.
...
def setup_tts_addon_patch():
    ...
    try:
        ...
        logger.debug("AI-Hints: BeautifulSoup not installed; skipping TTS hint-stripping patch.")
        BeautifulSoup = None
