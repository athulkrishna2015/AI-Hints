...
class AIClient:
    ...
    def generate_options(self, front: str, back: str, override_provider: str = None, only_this_provider: bool = False) -> Dict[str, List[str]]:
        ...
        system_prompt = (
            ...
            "4. REAL-WORLD ACCURACY: Do NOT generate 'synthetic' or made-up terms by simply swapping adjectives in the answer (e.g., if the answer is 'Concurrent List', do not make up 'Parallel List'). All distractors MUST be real, existing concepts, names, laws, or facts within the same subject domain. Use other real members of the same category as distractors.\n"
            "5. CLOZE ANSWER FORMAT: The 'Back / correct answer' field IS the exact correct answer. Options MUST match its format and type precisely. For Cloze deletion cards (where Front contains a blank '[...]'), the provided 'Back / correct answer' is already the exact correct answer—accept it exactly as-is without any modification, shortening, or further extraction.\n"
            "   - If the correct answer is a SHORT STANDALONE value (a number like '141', a year like '1947', a name, a term), ALL options must also be similar short standalone values of the same type. Do NOT expand them into full sentences.\n"
            "   - If the correct answer is a PHRASE OR SENTENCE, all options must be similar-length phrases or sentences.\n"
            "   - FRAGMENT EXPANSION EXCEPTION: Only expand if the cloze is clearly a word fragment embedded mid-word in the surrounding text (e.g. '{{c1::anti}}ferromagnet' → 'antiferromagnet'). This does NOT apply when the cloze is a standalone value.\n"
            "6. MULTI-CLOZE HANDLING: For multiple clozes with the same ID, each option MUST be a comma-separated list of values (e.g., 'val1, val2') corresponding to each cloze in order.\n"
            "7. NO VERBATIM HINTS: Hints must provide underlying principles, mnemonics, or contextual clues. Never repeat card content verbatim.\n"
            "8. CONCISE: Keep hints short, specific, and focused. Avoid wordy explanations.\n"
            "9. SEQUENTIAL ELEMENTS: If the card refers to a specific numbered or sequential item (like a constitutional Article, legal Section, Amendment, Rule, or Chapter) and the blank is the description/definition of that item, the distractors must be the actual, real descriptions/definitions of adjacent numbered items (e.g. if the answer is the definition of Article 13, use the actual, real definitions of Articles 12, 14, or 15 as distractors). Do not invent speculative or synthetic variations.\n"
            "10. SUBJECT-ALIGNED NUMBERS: If the correct answer is a specific number (like a constitutional Article, Section, or Law number), the distractors should be other famous, prominent, or highly relevant numbers associated with the exact same subject, entity, or category (e.g., if the correct answer is Article 61 which deals with the President's impeachment, use other major President-related articles like Article 52, 72, or 123 as distractors, instead of just mathematically adjacent numbers like 60 or 62).\n"
            "11. LANGUAGE CONSISTENCY: The hints and all options/distractors MUST be generated in the exact same language as the question/content provided in the prompt (e.g., if the question is in Malayalam, generate the hints and distractors in Malayalam; if in Spanish, generate in Spanish; if in English, generate in English). Never explain or write hints in English if the card content is in a non-English language.\n\n"
